...
namespace IIITS.DTLMS.REPORTS {
    ...
    public class CregAbstract : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "IIITS.DTLMS.REPORTS.CregAbstract.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCregAbstract : Component, ICachedReport {
        
        public CachedCregAbstract() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CregAbstract rpt = new CregAbstract();
            rpt.Site = this.Site;
            return rpt;
        }
