<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="TCBilling.aspx.cs" Inherits="IIITS.DTLMS.TCRepair.TCBilling" %>
    ...
    <script src="../Scripts/functions.js" type="text/javascript"></script>
     <script type="text/javascript" >
         function ValidateMyForm() {
             ...
             if (document.getElementById('<%= txtPOdate.ClientID %>').value == "") {
                 alert('Enter Valid PO Date')
                ...
                <div class="span12">
                    ...
                    <div class="widget blue">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>TC Billing</h4>
                            <span class="tools">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                  <asp:TextBox ID="txtPONo" runat="server" TabIndex="3"></asp:TextBox> 
                            </div>
                        </div>
                    </div>
                                 ...
                                 <div class="span5">
                                    ...
                                    <div class="controls">
                                        <div class="input-append">
                                               <asp:TextBox ID="txtDescription" runat="server" TabIndex="5" 
                                    ...
                                    <div class="span3"></div>
                                     <div class="span2">
                                        <asp:Button ID="cmdSend" runat="server" Text="Send to Payment"  OnClientClick="javascript:return ValidateMyForm()"
                                        CssClass="btn btn-primary"  TabIndex="6" onclick="cmdSend_Click" />
                                      </div>
                                      <%-- <div class="span1"></div>--%>
                                     <div class="span1">  
                           ...
                           <asp:GridView ID="grdPendingTc" ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found"
                                ...
                                <Columns>
                                     ...
                                     <asp:TemplateField AccessibleHeaderText="TC_CODE" HeaderText="TC Code" >                                
                                        <ItemTemplate>                                       
