<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="RecieveTransCreate.aspx.cs" Inherits="IIITS.DTLMS.StoreTransfer.ReceiveTcCreate" %>
...
--%>
                       ...
                       <div class="control-group">
                        ...
                        <div class="space20"></div>
                              ...
                              <asp:GridView ID="grdIndentDetails" 
                                ...
                                runat="server" TabIndex="16" OnPageIndexChanging="grdIndentDetails_PageIndexChanging">
          ...
          <div class="row-fluid" >
                <div class="span12">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="widget-body form" >
                                ...
                                <asp:Panel ID="pnlApproval" runat="server" >
                                    <div class="row-fluid">
                                    <div class="span1">
                                       <asp:TextBox ID="txtInvoiceId" runat="server" Width="50" Visible="false" ></asp:TextBox></div>
                    <div class="span5">
                    <div class="control-group">
                  ...
                  <div class="control-group">
                            <label class="control-label">Recieved From Store</label>
                            <div class="controls">
                                <div class="input-append">                                                       
 ...
 <asp:Panel ID="pnlApproval1" runat="server" >
   <div class="row-fluid">
                  ...
                  <div class="row-fluid">
                                    <div class="span1">
                                       <asp:TextBox ID="TextBox1" runat="server" Width="50" Visible="false" ></asp:TextBox></div>
                   <div class="span5">
                          <div class="control-group">
