...
namespace IIITS.DTLMS.TRM_Service {
    ...
    public interface IService1 {
        ...
        string SendDTCDetailstoTrms(string DTCName, string DTCCode, string FeederCode, string Longitude, string Latitude, string OffCode, string Capacity, string dtccommisiondate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/SendDTCDetailstoTrms", ReplyAction="http://tempuri.org/IService1/SendDTCDetailstoTrmsResponse")]
        System.Threading.Tasks.Task<string> SendDTCDetailstoTrmsAsync(string DTCName, string DTCCode, string FeederCode, string Longitude, string Latitude, string OffCode, string Capacity, string dtccommisiondate);
        ...
        string SendupdateDTCDetailstoTrms(string DTCName, string DTCCode, string FeederCode, string Longitude, string Latitude, string OffCode, string Capacity, string dtccommisiondate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/SendupdateDTCDetailstoTrms", ReplyAction="http://tempuri.org/IService1/SendupdateDTCDetailstoTrmsResponse")]
        System.Threading.Tasks.Task<string> SendupdateDTCDetailstoTrmsAsync(string DTCName, string DTCCode, string FeederCode, string Longitude, string Latitude, string OffCode, string Capacity, string dtccommisiondate);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IService1Channel : IIITS.DTLMS.TRM_Service.IService1, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service1Client : System.ServiceModel.ClientBase<IIITS.DTLMS.TRM_Service.IService1>, IIITS.DTLMS.TRM_Service.IService1 {
        ...
        public string SendDTCDetailstoTrms(string DTCName, string DTCCode, string FeederCode, string Longitude, string Latitude, string OffCode, string Capacity, string dtccommisiondate) {
            return base.Channel.SendDTCDetailstoTrms(DTCName, DTCCode, FeederCode, Longitude, Latitude, OffCode, Capacity, dtccommisiondate);
        }
        
        public System.Threading.Tasks.Task<string> SendDTCDetailstoTrmsAsync(string DTCName, string DTCCode, string FeederCode, string Longitude, string Latitude, string OffCode, string Capacity, string dtccommisiondate) {
            return base.Channel.SendDTCDetailstoTrmsAsync(DTCName, DTCCode, FeederCode, Longitude, Latitude, OffCode, Capacity, dtccommisiondate);
        }
        ...
        public string SendupdateDTCDetailstoTrms(string DTCName, string DTCCode, string FeederCode, string Longitude, string Latitude, string OffCode, string Capacity, string dtccommisiondate) {
            return base.Channel.SendupdateDTCDetailstoTrms(DTCName, DTCCode, FeederCode, Longitude, Latitude, OffCode, Capacity, dtccommisiondate);
        }
        
        public System.Threading.Tasks.Task<string> SendupdateDTCDetailstoTrmsAsync(string DTCName, string DTCCode, string FeederCode, string Longitude, string Latitude, string OffCode, string Capacity, string dtccommisiondate) {
            return base.Channel.SendupdateDTCDetailstoTrmsAsync(DTCName, DTCCode, FeederCode, Longitude, Latitude, OffCode, Capacity, dtccommisiondate);
        }
