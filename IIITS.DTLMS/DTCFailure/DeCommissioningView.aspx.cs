    ...
    {        
        ...
        public void LoadDecommAlreadyCreated(string sType)
        {
            ...
            try
            {
                ...
                if (sType == "1")
                {
                    lblGridType.Text = "DTC Failure Decommissioning Details :";
                }
                else if(sType == "2")
                {
                    lblGridType.Text = "DTC Enhancement Decommissioning Details :";
                }
                else if (sType == "4")
                {
                    lblGridType.Text = "DTC Failure with Enhancement Decommissioning Details :";
                }
            ...
            catch (Exception ex)
            {
                ...
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "LoadDecommAlreadyCreated");
            }
        }
        ...
        public void LoadAllDecomm(string sType)
        {
            ...
            try
            {
                ...
                {
                    lblMessage.Text = "Note : No " + sMsg + " DTC Available Please Declare the DTC " + sMsg + " before Decommissioning";
                    grdReplacementDetails.DataSource = dt;
                    grdReplacementDetails.DataBind();
                }
        ...
        protected void grdReplacementDetails_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdReplacementDetails_RowDataBound");
            }
        }
        ...
        public void LoadNewDTCDecomm()
        {
            ...
            try
            {
                ...
                lblGridType.Text = "New DTC Commission Decommissioning Details :";
            ...
            catch (Exception ex)
            {
                ...
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "LoadNewDTCInvoiceAlreadyCreated");
            }
        }
        ...
        protected void grdNewDTCReplace_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdNewDTCReplace_PageIndexChanging");
            }
        }
        protected void grdNewDTCReplace_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdInvoice_RowCommand");
        ...
        protected void grdNewDTCReplace_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (cmbType.SelectedValue == "3")
                    {
                        lnkCreate1.Text = "DTC Commission";
                    }
                }
            }
            catch (Exception ex)
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdNewDTCReplace_RowDataBound");
