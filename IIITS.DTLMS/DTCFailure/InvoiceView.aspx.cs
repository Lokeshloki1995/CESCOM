    ...
    public partial class InvoiceView : System.Web.UI.Page
    {
        ...
        public void LoadExistingInvoice(string sType)
        {
            try
            {
                ...
                if (sType == "1")
                {
                    lblGridType.Text = "DTC Failure Invoice Details";
                }
                else if (sType == "2")
                {
                    lblGridType.Text = "DTC Enhancement Invoice Details";
                }
                else if (sType == "4")
                {
                    lblGridType.Text = "DTC Failure with Enhancement Invoice Details";
                }
        ...
        public void LoadAllInvoices(string sType)
        {
            ...
            try
            {
                ...
                {
                    lblMessage.Text = "Note : No " + sMsg + " DTC Available Please Declare the DTC  " + sMsg + " before creating a Invoice";
                    grdInvoice.DataSource = dt;
                    grdInvoice.DataBind();
                }
            ...
            catch (Exception ex)
            {
                ...
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "LoadAllInvoices");
            }
        }
        ...
        protected void grdInvoice_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdInvoice_PageIndexChanging");
            }
        }
        ...
        public void LoadNewDTCInvoiceAlreadyCreated()
        {
            ...
            try
            {
                ...
                lblGridType.Text = "New DTC Commission Invoice Details :";
        ...
        protected void grdNewDTCInvoice_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdNewDTCInvoice_PageIndexChanging");
            }
        }
        ...
        protected void grdNewDTCInvoice_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdNewDTCInvoice_RowCommand");
            }
        }
