...
{
    public partial class ReductionView : System.Web.UI.Page
    {
        ...
        protected void cmdNew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sStatasFalg = HttpUtility.UrlEncode(Genaral.UrlEncrypt("5"));
        ...
        public void LoadAllDTCReductions()
        {
            try
            {
                ...
                DataTable dtDetails = objEnhance.LoadAllDTCReduced(objEnhance);
        ...
        public void LoadAlreadyReduced()
        {
            try
            {
                clsEnhancement objEnhance = new clsEnhancement();
                objEnhance.sOfficeCode = objSession.OfficeCode;
                DataTable dtDetails = objEnhance.LoadAlreadyReduced(objEnhance);
                grdEnhancement.DataSource = dtDetails;
                grdEnhancement.DataBind();
                ViewState["Enhancement"] = dtDetails;
        ...
        protected void grdEnhancement_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "Preview")
                {
                    ...
                    //  string sActionType = HttpUtility.UrlEncode(Genaral.UrlEncrypt("V"))   + "&ActionType=" + sActionType;
        ...
        public string[] CheckAlreadyFailureEnry(string sDTCCode)
        {
            ...
            try
            {
                ...
                bResult = objApproval.CheckAlreadyExistEntry(sDTCCode, "47");
                if (bResult == true)
                {
                    Arr[0] = "Capacity Reduction Already done for DTC Code " + sDTCCode + ", Waiting for Approval";
                    Arr[1] = "2";
                    return Arr;
        ...
        protected void Export_ClickEnhancement(object sender, EventArgs e)
        {
            ...
            if (dtDetails.Rows.Count > 0)
            {
                ...
                string filename = "AllReductionDetails" + DateTime.Now + ".xls";
