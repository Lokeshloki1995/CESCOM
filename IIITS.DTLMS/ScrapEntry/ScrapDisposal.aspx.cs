        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    strQry += "Query=SELECT TC_CODE,TC_SLNO,TM_NAME FROM TBLTCMASTER,TBLTRANSMAKES,TBLSCRAPOBJECT,TBLSCRAPTC WHERE TC_LOCATION_ID LIKE '" + objSession.OfficeCode + "%' AND ";
