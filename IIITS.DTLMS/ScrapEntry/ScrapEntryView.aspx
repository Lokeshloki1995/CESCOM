...
//         }
    ...
    .descending th a {
     ...
     .both th a {
      ...
      <script type="text/javascript">
     //OM allow to enter nums for 6 digits
        ...
        // Om allow only Numbers to paste
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-append">                                                                                                           
                                                     <asp:TextBox ID="txtWONo" runat="server" MaxLength="50" onkeypress="return onlyNumbers(event)" onchange ="return cleanSpecialAndChar(this)"></asp:TextBox>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul><li>
                   This Web Page Can Be Used To Search TC Which is Declared as Scrap and To Send TC For Disposal</li>
                     <li> Enter or Search OM No from OM No TextBox</li>
                    <li>   To Load Scrap TC Click On <u>Load Scrap Transformers</u> Button</li>
                     <li>  Select CheckBoxes For The TC which will be Sent For Disposal</li>
                      <li> After Seleting TC Click On <u>Send To Dispose</u> Button</li>
                      <li>  Fill All The Required Details and Click On <u>Save</u> Button to Save Dispose Details
                       </li></ul>
