<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="DtrRepairerWise.aspx.cs" Inherits="IIITS.DTLMS.Reports.DtrRepairerWise" %>
            ...
            <div class="row-fluid">
             <div class="span8">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
   Dtr Repairer PerFormance Report
                   </h3>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul><li>
                     This Report Will Display DTR Repair Performance</li>
                  <li> Select Circle, division, FromDate, ToDate </li>
                  <li> It will display graph showing Dtc Repetedly being fail by Repairer for perticular Division </li>
                  <li> In Graph Failure bar indicate Failed only 1 time </li>
                  <li>  Repairer Name with counts indicate failed more than 1 time with that perticular repairer
                        </li></ul>
                </div>
