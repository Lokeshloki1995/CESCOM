        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul><li>
                  This Report is used to View the DTR present in Selected location</li>
                 <li>  You Can Take Report by selecting DTRMake or Capacity or Circle or Division </li>
                 <li>  you can Take Full Report by seclecting nothing in the form</li>
                 <li>  By Clicking Generate Report Button crystal Report will be Generate After that you can download it in to PDF file
               </li><li>    By Clicking ExportExcel Button Excel will be downloaded
                        </li></ul>
                </div>
