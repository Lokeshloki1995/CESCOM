...
<div style="float:right" >
    ...
    <div class="span1">
     ...
     <div>
                             <asp:GridView ID="grdTalukdetails" AutoGenerateColumns="false" PageSize="15" AllowPaging="true"
                             ...
                             <HeaderStyle CssClass="both"/>
                                    <Columns>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="Dist_NAME" HeaderText="Taluk Code" Visible="true" SortExpression="TQ_CODE">
                                         ...
                                         <asp:TextBox ID="txtTalukCode" runat="server" placeholder="Enter Taluk Code" Width="150px" CssClass="span12" onkeypress="return onlyNumbers(event)" onchange = "cleanCharAndSpecial(this)" MaxLength="2"></asp:TextBox>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul><li>
                  This Web Page Can Be Used To View Taluk Details and To Add New Taluk </li>
                  <li> To Edit Existing Details Click On <u>Edit</u> LiknkButton</li>
                 <li> To Add New Taluk Click On <u>New Taluk</u> LiknkButton
                    </li></ul>
