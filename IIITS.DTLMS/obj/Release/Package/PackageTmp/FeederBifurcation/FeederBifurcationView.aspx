        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <asp:GridView ID="grdFdrView" ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found"
                    ...
                    runat="server"
                    AllowSorting="true" OnRowCommand="grdFdrView_RowCommand"  onpageindexchanging="grdFdrView_PageIndexChanging"   >
                    <Columns>
                        ...
                        <asp:TemplateField AccessibleHeaderText="OLD_FEEDER_CODE"  HeaderStyle-ForeColor="White"  HeaderText="Old Feeder Code">
                            <ItemTemplate>
                             ...
                             <FooterTemplate>
                              <asp:Panel ID="panel1" runat="server" DefaultButton="imgBtnSearch" >
                                <asp:TextBox ID="txtOldFeederCode" MaxLength="4" runat="server" placeholder="Enter Old Feeder Code" Width="150px" onkeypress="return characterAndnumbers(event)" onchange = "return cleanSpecialChars(this)"  ></asp:TextBox>
                             </asp:Panel>
                             </FooterTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField AccessibleHeaderText="NEW_FEEDER_CODE"  HeaderStyle-ForeColor="White"  HeaderText="New Feeder Code" >
                            <ItemTemplate>
                             ...
                             <FooterTemplate>
                              <asp:Panel ID="panel2" runat="server" DefaultButton="imgBtnSearch" >
                                <asp:TextBox ID="txtNewFeederCode" MaxLength="4" runat="server" placeholder="Enter New Feeder Code" Width="150px"  onkeypress="return characterAndnumbers(event)" onchange = "return cleanSpecialChars(this)"  ></asp:TextBox>
                             </asp:Panel>
                             </FooterTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField AccessibleHeaderText="COUNT_DTC"  HeaderStyle-ForeColor="White"  HeaderText="Number of DTC's" >
                            <ItemTemplate>
                                <asp:Label ID="lblNumberofDTC" runat="server" Text='<%# Bind("COUNT_DTC") %>' Style="word-break: break-all;" Width="120px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField AccessibleHeaderText="SECTION_OFFICER"  HeaderStyle-ForeColor="White"  HeaderText="Section Officer" >
                            <ItemTemplate>
                        ...
                        <asp:TemplateField AccessibleHeaderText="CREATED_ON"  HeaderStyle-ForeColor="White"   HeaderText="Created On">
                            <ItemTemplate>
                                <asp:Label ID="lblCreatedOn" runat="server" Text='<%# Bind("CREATED_ON") %>' Style="word-break: break-all;" Width="120px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField AccessibleHeaderText="APPROVED_ON"  HeaderStyle-ForeColor="White"  HeaderText="Approved On" >
                            <ItemTemplate>
                                <asp:Label ID="lblApprovedOn" runat="server" Text='<%# Bind("APPROVED_ON") %>' Style="word-break: break-all;" Width="120px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField AccessibleHeaderText="APPROVED_BY"  HeaderStyle-ForeColor="White" HeaderText="Approved By" >
                            <ItemTemplate>
                                <asp:Label ID="lblApprovedBy" runat="server" Text='<%# Bind("APPROVED_BY") %>' Style="word-break: break-all;" Width="120px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                         <asp:TemplateField AccessibleHeaderText="STATUS"  HeaderStyle-ForeColor="White" HeaderText="Status" >
                            <ItemTemplate>
