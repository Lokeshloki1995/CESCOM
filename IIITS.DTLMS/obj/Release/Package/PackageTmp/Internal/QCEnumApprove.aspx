                                        ...
                                        <div class="span1"></div>
                                           <div class="span5">
                                               ...
                                               <div class="control-group" runat="server" id="dvSection">
                                                   ...
                                                   <div class="controls">   
                                                       <div class="input-append">
                                                            <asp:DropDownList ID="cmbSection" runat="server"  TabIndex="2">                                   
                                                            </asp:DropDownList>
                                                       </div>
                                                    </div>
                                               </div>
                                               ...
                                               <div class="control-group" runat="server" id="dvLocName" style="display:none">                                              
                                                   ...
                                                   <div class="controls">   
                                                       <div class="input-append">
                                                            <asp:DropDownList ID="cmbLocationName" runat="server"  TabIndex="2">                                   
                                                            </asp:DropDownList>
                                                       </div>
                                                    </div>
                                               </div>
                                           ...
                                           <div class="control-group">
                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="control-group" runat="server" id="dvTransType" style="display:none">
                                                <label class="control-label">Transformer Type<span class="Mandotary"> *</span></label>
                                                <div class="controls">   
                                                    <div class="input-append">
                                         ...
                                         <div class="control-group">
                                            ...
                                            <div class="control-group">
                                             ...
                                             <div class="control-group">
                                                ...
                                                <div class="controls">   
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtTankCapacity" runat="server" MaxLength="10" TabIndex="12"
                                    ...
                                    <div class="row-fluid">                                   
                                        <div class="span5">    
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">   
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtDTCCode" runat="server" MaxLength="6" TabIndex="14"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">DTC Code (Ip Enum)<span class="Mandotary"> *</span></label>
                                                <div class="controls">   
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtIPDTCCode" runat="server" MaxLength="10" TabIndex="16"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>   
                                        ...
                                        <div class="span5">                                        
                                          <div class="control-group">
                                                ...
                                                <div class="controls">   
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtoldDTCCode" runat="server" MaxLength="10" TabIndex="15"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="widget-body">
                ...
                <div class="span3"></div>
                    ...
                    <asp:Button ID="btnPending" runat="server" Text="Pending for Clarification"  CssClass="btn btn-primary" 
                        TabIndex="20" onclick="btnPending_Click"    />
                    </div>   
                     <div class="span1">
                     ...
                     <div class="span1">
                        ...
                        TabIndex="20" onclick="cmdNextDetails_Click"  />
                    </div>  
