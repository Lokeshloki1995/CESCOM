                                ...
                                <Columns>
                                  ...
                                  <asp:TemplateField AccessibleHeaderText="TC Code" HeaderText="DTr Code" >                                
                                   ...
                                   <asp:TextBox ID="txtTcCode" runat="server" placeholder="Enter DTr Code">
                                     ...
                                     <asp:TemplateField AccessibleHeaderText="ED_OPERATOR1" HeaderText="Details Entered By" Visible="true">                                
                                        <ItemTemplate>                                       
                                            <asp:Label ID="lblOperator1" runat="server" Text='<%# Bind("ED_OPERATOR1") %>' style="word-break:break-all" width="120px" ></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
