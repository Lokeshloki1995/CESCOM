                                ...
                                <div class="row-fluid">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <asp:TextBox ID="txtDtrCode" runat="server"  MaxLength="6" onkeypress="return onlyNumbers(event)" onchange = "return cleanSpecialAndChar(this)"></asp:TextBox>
                                    ...
                                    <label class="control-label">
                                                ...
                                                <asp:DropDownList ID="cmbStatus" runat="server"  Width="150px" TabIndex="9" > 
                                                     ...
                                                     <asp:ListItem Text ="Suspense" Value="10"/>
                                                     <asp:ListItem Text ="NonRepairable" Value ="9"/>
                                                    <asp:ListItem Text ="Released Good" Value ="11"/>
                                                </asp:DropDownList>
                                                </div>
                                            </div>
                                        ...
                                        <asp:GridView ID="grdDtrDetails" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-advance table-hover">
                                            <Columns>
                                                ...
                                                <asp:TemplateField AccessibleHeaderText="TC_Location" HeaderText="TC Location" Visible="true"
                                                    HeaderStyle-ForeColor="Black">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblOffNmae" runat="server" Text='<%# Bind("TC_LOCATION_ID") %>' Style="word-break: break-all;"
                                                            Width="200px" ForeColor="Black"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
