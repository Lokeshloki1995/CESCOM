                                        ...
                                        <div class="controls">
                                            <div class="input-append">     
                                                <asp:HiddenField ID="hdfScrapDetailsId" runat="server" />                                  
                                                  <asp:TextBox ID="txtOMNo" onpaste ="return false" onchange ="return CleanSpecialSymbols(this)"    runat="server" MaxLength="25" TabIndex="5" ></asp:TextBox>           
                                        ...
                                        <div class="controls">
                                            <div class="input-append">        
                                              ...
                                              <asp:TextBox ID="txtScrapId"  runat="server" Visible="false"></asp:TextBox>
                                                <asp:TextBox ID="txtRemarks"  runat="server" TextMode="MultiLine" onpaste ="return false" onchange ="return CleanSpecialSymbols(this)" MaxLength="400" style="resize:none;height:75px" 
