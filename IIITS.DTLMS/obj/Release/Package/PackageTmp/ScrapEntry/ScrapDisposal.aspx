                 ...
                 <div class="span5">
                      ...
                      <label class="control-label">Invoice No<span class="Mandotary"> *</span></label>                        
                        <div class="controls">
                            <div class="input-append">                                                  
                              <asp:TextBox ID="txtInvoiceNo" onkeypress="return onlyNumbers(event)" ReadOnly="true" runat="server"></asp:TextBox>                            
                            </div>
                        </div>
                    </div>
                      ...
                      <label class="control-label">Quantity<span class="Mandotary"> *</span></label>                        
                        <div class="controls">
                            ...
                            <asp:HiddenField ID="hdfScrapDetailsId" runat="server" />                                                
                              <asp:TextBox ID="txtQuantity"  runat="server" onkeypress="return onlyNumbers(event)" 
                   ...
                   <div class="control-group">
                      <label class="control-label">Amount<span class="Mandotary"> *</span></label>                        
                        <div class="controls">
                            <div class="input-append">                                                  
                              <asp:TextBox ID="txtAmount" MaxLength="12" runat="server"  onkeypress="return onlyNumbers(event)" ></asp:TextBox>                            
                            </div>
                        </div>
                    </div>
                 ...
                 <div class="span5">
                  ...
                  <div class="control-group">
                      <label class="control-label">Send To<span class="Mandotary"> </span></label>                        
                        <div class="controls">
                            <div class="input-append">                                                  
                              <asp:TextBox ID="txtSendTo" onchange ="return CleanSpecialSymbols(this)"  MaxLength="200" runat="server"  ></asp:TextBox>                            
                            </div>
                        </div>
                  </div>
                      ...
                      <label class="control-label">Description<span class="Mandotary"> *</span></label>                         
                        <div class="controls">
                            <div class="input-append">                                                   
                                   ...
                                   style="resize:none;height:70px" onchange ="return CleanSpecialSymbols(this)" onkeyup="return ValidateTextlimit(this,500);"></asp:TextBox>                            
                            </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="widget blue">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                ...
                                <asp:TextBox ID="txtVehicleNo" onkeypress="return DontAllowPlusAndSingleQuotes(event)"  runat="server" MaxLength="50"></asp:TextBox>
                        ...
                        <div class="controls">
                            <div class="input-append">
                                ...
                                <asp:TextBox ID="txtChallen" onkeypress="return onlyNumbers(event)" runat="server" MaxLength="50"></asp:TextBox>
