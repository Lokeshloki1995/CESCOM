<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetStatus.aspx.cs" Inherits="IIITS.DTLMS.OilFlow.BudgetStatus" %>

<%--<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="BudgetStatus.aspx.cs" Inherits="IIITS.DTLMS.OilFlow.BudgetStatus" %>--%>
                            ...
                            <div class="widget-body form">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="BT_PONO" HeaderText="Purchase Order No">
                                            <ItemTemplate>
                                                <asp:Label ID="lblWONO" runat="server" Text='<%# Bind("BT_PONO") %>'
                                                    Width="80px" Style="word-break: break-all"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField AccessibleHeaderText="OSD_PO_DATE" HeaderText="Purchase Order Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblWODATE" runat="server" Text='<%# Bind("OSD_PO_DATE") %>'
                                                    Width="80px" Style="word-break: break-all"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="BT_AVL_AMNT" HeaderText="Budget Avalable Amnt">
                                          ...
                                          <asp:TemplateField AccessibleHeaderText="BT_CREDIT_AMNT" HeaderText="Budget Credit Amnt" Visible="false">
                                            <ItemTemplate>
