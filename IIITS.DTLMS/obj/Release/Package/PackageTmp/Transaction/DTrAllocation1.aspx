...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
       ...
       // function cleanSpecialAndChar(t) {
           ...
           // if (t.value = t.value.toString().replace(/[^0-9\n\r]+/g, '')) {
           //    
              //  alert(" Special charactes and characters are not allowed!");
               // return true;
          //  }
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span5">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <asp:TextBox ID="txtSecondDtrCode" runat="server" MaxLength="6"  onkeypress="return onlyNumbers(event)" onchange = "cleanSpecialAndChar(this)"></asp:TextBox>
