                            ...
                            <div class="form-horizontal">
                                <div class="row-fluid">
                                    ...
                                    <div class="span5">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">
                                                <asp:Label ID="lblFailDTr" runat="server" Text=" Failure DTr Code"></asp:Label> </label>
                                            <div class="controls">
                                                <div class="input-append">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <asp:TextBox ID="txtInvNumber" runat="server" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" style="width:180px!important">
                                               Total Oil Quantity(in Liter)</label>
                                            <div class="controls">
                                                <div class="input-append">
                                        ...
                                        <div class="control-group">
                                         ...
                                         <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <asp:TextBox ID="txtRVdate" runat="server" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <asp:TextBox ID="txtRVNumber" runat="server" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="control-group" >
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <asp:TextBox ID="txtInvQty" runat="server"  MaxLength="5" onpaste="return false"  onkeypress="return onlyNumbers(event)"  ></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="control-group" >
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <asp:TextBox ID="txtDecommInventry" runat="server" MaxLength="5" onpaste="return false" onkeypress="return onlyNumbers(event)"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                         </asp:Panel>
                                                ...
                                                <div class="input-append">
                                                    <asp:TextBox ID="txtCrDate" runat="server" ></asp:TextBox>
                                                     <asp:CalendarExtender ID="CalendarExtender2" runat="server" CssClass="cal_Theme1" 
                                                      TargetControlID="txtCrDate" Format="dd/MM/yyyy"></asp:CalendarExtender>    
                                                </div>
                                            </div>
                                        </div>
