                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            <asp:TextBox ID="txtManualInvNo" runat="server" MaxLength="25" TabIndex="6"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            <asp:TextBox ID="txtInvoiceDate" runat="server" MaxLength="10" TabIndex="8"></asp:TextBox>
                            ...
                            <div class="widget-body form">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="text-center" align="center">
                                            ...
                                            <asp:Button ID="cmdGatePass" runat="server" Text="Print GatePass" CssClass="btn btn-info"
