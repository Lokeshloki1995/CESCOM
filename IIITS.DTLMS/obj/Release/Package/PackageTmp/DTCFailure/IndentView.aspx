                 ...
                 <asp:TemplateField AccessibleHeaderText="WO_NO" HeaderText="Work Order No." SortExpression="WO_NO">
                    <ItemTemplate>
                     ...
                     <FooterTemplate>
                       ...
                       <asp:TextBox ID="txtWoNo" runat="server" placeholder="Enter WO No " Width="150px" MaxLength="17" onkeypress="return characterAndnumbersWk(event)" onchange ="return cleanSpecialCharsWk(this)"  ></asp:TextBox>
                  </asp:Panel>
                    </FooterTemplate>
                </asp:TemplateField>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul><li>
                  This Web Page Can Be Used To View All Types Of Indent(Failure,Failure with Enhancement,Enhancement,New DTC)</li>
                   <li>  To View Indent Details For The Particular Type Select From Type DropDownlist</li>
                  <li> To View More Details about Indent, Click On View LinkButton
