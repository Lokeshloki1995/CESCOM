                      ...
                      <asp:TemplateField AccessibleHeaderText="WO_NO" HeaderText="WorkOrder No." Visible="true" SortExpression="WO_NO">
                           ...
                           <FooterTemplate>
                             <asp:Panel ID="panel3" runat="server" DefaultButton="imgBtnSearch" >
                              <asp:TextBox ID="txtWoNo" runat="server" placeholder="Enter WO No " Width="120px" MaxLength="17" onkeypress="return characterAndnumbersWk(event)" onchange ="return cleanSpecialCharsWk(this)" ></asp:TextBox>
                           </asp:Panel>
                           </FooterTemplate>
                        </asp:TemplateField>
                         ...
                         <asp:TemplateField AccessibleHeaderText="TI_INDENT_NO" HeaderText="Indent No." SortExpression="TI_INDENT_NO">
                           ...
                           <FooterTemplate>
                            ...
                            <asp:TextBox ID="txtIndentNo" runat="server" placeholder="Enter Indent No " Width="120px" MaxLength="50" onkeypress="return onlyNumbers(event)" onchange ="return cleanSpecialAndChar(this)" ></asp:TextBox>
                           </asp:Panel>
                           </FooterTemplate>
                        </asp:TemplateField>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul><li>
                   This Web Page Can Be Used To View All Types Of Invoice(Failure,Failure with Enhancement,Enhancement,New DTC)</li>
                     <li> To View Invoice Details For The Particular Type Select From Type DropDownlist</li>
                      <li> To View More Details about Invoice, Click On View LinkButton
                      </li></ul>
