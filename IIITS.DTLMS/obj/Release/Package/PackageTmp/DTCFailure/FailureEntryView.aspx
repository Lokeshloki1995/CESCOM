 ...
 <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                 ...
                 <asp:GridView ID="grdFailureDetails" AutoGenerateColumns="false" PageSize="10" 
                 ...
                 CssClass="table table-striped table-bordered table-advance table-hover" ShowFooter="true"
                  runat="server"  onpageindexchanging="grdFailureDetails_PageIndexChanging" 
                                                onrowcommand="grdFailureDetails_RowCommand" 
                            onrowdatabound="grdFailureDetails_RowDataBound" OnSorting="grdFailureDetails_Sorting" AllowSorting="true">
