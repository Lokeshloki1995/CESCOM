    ...
    public partial class TcMaintainance : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    Genaral.Load_Combo("SELECT MD_ID,MD_NAME FROM TBLMASTERDATA WHERE MD_TYPE = 'OL' ORDER BY MD_ID", "--Select--", cmboilLevel);
                    Genaral.Load_Combo("SELECT MD_ID,MD_NAME FROM TBLMASTERDATA WHERE MD_TYPE = 'LI' ORDER BY MD_ID", "--Select--", cmbArrester);
        ...
        protected void cmdSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ValidateForm() == true)
                {
                    ...
                    objTcMainainance.sOilLeakage = cmboilLevel.SelectedValue.ToString();                   
                    objTcMainainance.sDescription = txtTmDescription.Text;
                    objTcMainainance.sRadiator = txtRadiator.Text;
                    objTcMainainance.sArrestor = cmbArrester.SelectedValue.ToString();     
        ...
        bool ValidateForm()
        {
            ...
            { 
                ...
                {
                    txtDtcCode.Focus();
                    ShowMsgBox("Enter Transformer DTC code");
                    return false;
                }
        ...
        public void GetTCDetials(string strDTCCode)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "GetTCDetials");
            }
        }
