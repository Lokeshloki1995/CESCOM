...
namespace IIITS.DTLMS.Maintainance
{
    public partial class TcMaintainanceView : System.Web.UI.Page
    {
        ...
        public void LoadHalfYearTcMaintainanceDetails()
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "LoadHalfYearTcMaintainanceDetails");
            }
        }
        ...
        protected void grdTcMaintainance_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdTcMaintainance_PageIndexChanging");
            }
        }
        ...
        protected void grdTcMaintainance_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "search")
                {
                    ...
                    if (txtTcCode.Text != "")
                    {
                        sFilter += " TM_TC_CODE Like '%" + txtTcCode.Text.Replace("'", "`") + "%' AND";
                    }
                    if (txtDtcname.Text != "")
                    {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdTcMaintainance_RowCommand");
            }
        }
        ...
        protected void rdbQuarterly_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "rdbQuarterly_CheckedChanged");
            }
        }
        ...
        protected void rdbHalfYearly_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "rdbHalfYearly_CheckedChanged");
            }
        }
        ...
        protected void Export_clickTCMaintainance(object sender, EventArgs e)
        {
            ...
            //    }
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    dt.Columns["DTCNAME"].ColumnName = "DTC Name";
                    dt.Columns["TM_DT_CODE"].ColumnName = "DTC CODE";
                    dt.Columns["TM_TC_CODE"].ColumnName = "DTR CODE";
                    ...
                    dt.Columns["DTC Name"].SetOrdinal(1);
