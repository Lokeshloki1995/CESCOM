...
namespace IIITS.DTLMS.Maintainance
{
    public partial class PrevMaintanance : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    strQry += " WHERE  FD_FEEDER_ID = FDO_FEEDER_ID AND (FDO_OFFICE_CODE LIKE '"+ objSession.OfficeCode +"%' ";
        ...
        protected void cmbIndexSelection_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "cmbIndexSelection_SelectedIndexChanged");
            }
        }
