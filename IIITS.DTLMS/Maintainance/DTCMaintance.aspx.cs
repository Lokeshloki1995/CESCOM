    ...
    public partial class DTCMaintance : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                txtMaintainanceDate_CalendarExtender1.StartDate = Convert.ToDateTime(sFromDate);
                ...
                if (!IsPostBack)
                {
                    ...
                    if (Request.QueryString["MaintId"] != null && Request.QueryString["MaintId"].ToString() != "")
                    {
                    ...
                    if (Request.QueryString["MaintType"] != null && Request.QueryString["MaintType"].ToString() != "")
                    {
        ...
        public void LoadSearchWindow()
        {
            try
            {
                Genaral.Load_Combo("SELECT MD_ID,MD_NAME FROM TBLMASTERDATA WHERE MD_TYPE = 'MT' ORDER BY MD_ID", "--Select--", cmbType);
                Genaral.Load_Combo("SELECT US_ID,US_FULL_NAME FROM TBLUSER WHERE NVL(US_EFFECT_FROM,SYSDATE-1)<=SYSDATE AND US_STATUS='A' and US_OFFICE_CODE LIKE '" + objSession.OfficeCode + "%' ORDER BY US_ID", "--Select--", cmbMaintainedBy);

                string strQry = string.Empty;
                strQry = "Title=Search and Select DTC Details&";
                strQry += "Query=select DT_CODE,DT_NAME  FROM TBLDTCMAST WHERE DT_OM_SLNO  LIKE '" + objSession.OfficeCode + "%'  AND {0} like %{1}% order by DT_CODE&";
        ...
        public void GetTcMaintainanceDeatils()
        {
            try
            {
                ...
                txtMaintainanceDate.Text = objMaintainance.sTmDate.Replace("-","/");
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, " GetTcMaintainanceDeatils");
            }
        ...
        protected void cmdSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objTcMaintainance.GetDtcBasicDetails(objTcMaintainance);
        ...
        protected void cmdSave_Click(object sender, EventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "cmbSave_Click");
            }
        }
        ...
        public void LoadDtcMaintance()
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "LoadDtcMaintance");
            }
        }
        ...
        protected void grdDtcMaintainance_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "grdDtcMaintainance_RowCommand");
            }
        }
        ...
        protected void grdDtcMaintainance_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "grdDtcMaintainance_PageIndexChanging");
            }
        }
    }
}