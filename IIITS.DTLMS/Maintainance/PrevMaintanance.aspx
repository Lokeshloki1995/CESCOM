                            ...
                            <asp:GridView ID="grdPrevMaintainance" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="DT_CODE" HeaderText="DTC code" Visible="true">                                
                                     ...
                                     <asp:TemplateField AccessibleHeaderText="TC_CODE" HeaderText="TC Code" Visible="false">                                
                                        <ItemTemplate>                                       
                                            <asp:Label ID="lblTcCode" runat="server" Text='<%# Bind("TC_CODE") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField AccessibleHeaderText="DT_NAME" HeaderText="DTC Name" Visible="true">                                
                                        <ItemTemplate>                                       
