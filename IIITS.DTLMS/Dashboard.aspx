...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        //Charactes and space & : - 1 2 . to search Office Name
        function characterAndspecialOff(event) {
            var evt = (evt) ? evt : event;
            var charCode = (evt.charCode) ? evt.charCode : ((evt.keyCode) ? evt.keyCode :
            ((evt.which) ? evt.which : 0));
            if ((charCode < 65 || charCode > 90) &&
             (charCode < 97 || charCode > 122) && charCode != 32 && charCode != 38 && charCode != 58 && charCode != 45 && charCode != 49 && charCode != 50 && charCode != 46) {

                return false;
            }
            return true;
        }
        //Remove Numbers, Special characters except space to search Office Name
        function cleanSpecialAndNumOff(t) {
                         ...
                         <div class="form-horizontal">
                              ...
                              <div class="span4">
                                   ...
                                   <asp:Label ID="Label1" runat="server"  Font-Bold="true"  
                                        Font-Size="Medium">Total No. Of DTC :  </asp:Label>
                                             <u>   <asp:HyperLink Target="_blank" runat="server" ID="lnkTotalNumberofDTC" CssClass="btn-link" Font-Size="Large"></asp:HyperLink> </u>
                          ...
                          <div class="span2">
                              ...
                              <u><asp:LinkButton ID="lnkChange" runat="server"  Font-Bold="true"   onclick="lnkChange_Click" CssClass="btn-link">Select Location</asp:LinkButton></u>
                          </div>
                          <div class="span4">
                              <marquee id="mrqLeft" direction ="left" onmouseover="this.stop()" onmouseout="this.start()">
                              <a target="_blank" href="/LatestUpdate.aspx" style="font-weight:bold;color:Red;cursor:pointer;text-decoration:none" >* Click here for Recent Changes Done in Appication *</a></marquee>
                          ...
                          <div class="span4">
                              <marquee id ="mrqright" direction ="left" onmouseover="this.stop()" onmouseout ="this.start()">
                                  <a target="_blank" href="https://play.google.com/store/apps/details?id=com.iiits.dtlmscesc" style ="font-weight:bold;color:blue;cursor:pointer;text-decoration:none">Click here to download DTLMS Android Application</a></marquee>
<%--                              <a target="_blank" href="/DashboardForm/DownLoad.aspx" style ="font-weight:bold;color:blue;cursor:pointer;text-decoration:none">Click here to download DTLMS Android Application</a></marquee>--%>
                           </div>    
                              ...
                              <marquee id ="mrqright" direction ="left" onmouseover="this.stop()" onmouseout ="this.start()">
                                  <a target="_blank" href="/VideoTutorial/TutorialVideos.aspx" style ="font-weight:bold;color:blue;cursor:pointer;text-decoration:none">Click here for New DTC Commissioning Video Tutorial</a></marquee>
                           </div>  
                ...
                <div class="metro-nav">
                 ...
                 <asp:LinkButton ID="Failure" runat="server" onclick="Failure_Click"><i class="icon-bar-chart"></i><div class="info"><asp:Label ID="lblToatlPending" runat="server" ></asp:Label></div><div class="status">Pending DTC For Replacement</div></asp:LinkButton>
                  ...
                  <asp:LinkButton ID="estimation" runat="server" onclick="estimation_Click" ><i class="icon-anchor"></i><div class="info"> <asp:Label ID="lblPendingEstimation" runat="server" ></asp:Label></div><div class="status" >Pending for Estimation</div></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="Decommissioning" runat="server" OnClick="Decommissioning_Click"  ><i class="icon-bell"></i><div class="info" ><asp:Label ID="lblPendingDeCommission" runat="server" ></asp:Label></div><div class="status">Pending for RI</div></asp:LinkButton>
                    </div>

                    <div class="metro-nav-block nav-light-brown" style="width:171px;background-color:#f0ad4e">
                    <asp:LinkButton ID="RI" runat="server" onclick="RI_Click" > <i class="icon-retweet"></i><div class="info"><asp:Label ID="lblPendingRI" runat="server" ></asp:Label></div><div class="status">Pending for RV</div></asp:LinkButton>
                    </div>

                     <div class="metro-nav-block nav-light-blue" style="width:171px;background-color:#5cb85c">
                    <asp:LinkButton ID="CR" runat="server" onclick="CR_Click" > <i class="icon-retweet"></i><div class="info"><asp:Label ID="lblCrPending" runat="server" ></asp:Label></div><div class="status">Pending for CR</div></asp:LinkButton>
                    </div>
                 ...
                 <ul class="breadcrumb" style="font-weight:bold">
                  ...
                  <div class="metro-nav">                  
                    ...
                    <div class="metro-nav-block nav-block-yellow" style="background-color:#5cb85c;">
                      <asp:LinkButton ID="LinkButton2" runat="server" onclick="Faulty_Store_Click" > <i class="icon-home"></i><div class="info"><asp:Label ID="lblFaultyStore" runat="server" ></asp:Label></div><div class="status">Faulty DTr at Store (Repairable)</div></asp:LinkButton>
                    </div>
                     ...
                     <div class="metro-nav-block nav-light-blue" runat="server" id="dvReject" >
                       ...
                       <div class="metro-nav-block nav-light-purple" runat="server" id="Div4" >
                        <asp:LinkButton ID="lnkbtnFaultySupplier" runat="server" onclick="Faulty_Supplier_Click" > <i class="icon-hospital"></i><div class="info"><asp:Label ID="lblFaultySupplier" runat="server" ></asp:Label></div><div class="status">Faulty DTr at Supplier</div></asp:LinkButton>
                    </div>

                    <%-- <div class="metro-nav-block nav-block-blue" runat="server">
                     <asp:LinkButton ID="LinkButton" runat="server" onclick="Tcfailed_Click" > <i class="icon-inbox"></i><div class="info"><asp:Label ID="LabelTcfailed" runat="server" ></asp:Label></div><div class="status">Repaired  Good dtr</div></asp:LinkButton>
                    </div>--%>
                 ...
                 <ul class="breadcrumb" style="font-weight:bold">
                     <li>  DTR Details at Store
                       </li>
                </ul>  
                     <div class="metro-nav">
                          <div class="metro-nav-block nav-block-orange" style="background-color:#d9534f">
                       <asp:LinkButton ID="lnkRepairGood" runat="server" onclick="TCDetails_Click" > <i class="icon-ambulance"></i><div class="info"> <asp:Label ID="lblRepairGood" runat="server" ></asp:Label></div><div class="status" >Repaired Good Dtr</div></asp:LinkButton>
                    </div>
                    <div class="metro-nav-block nav-olive" style="background-color:#008B8B">
                       <asp:LinkButton ID="lnkBrandNew" runat="server" onclick="TCDetails_Click" > <i class="icon-ban-circle"></i><div class="info"><asp:Label ID="lblBrandNew" runat="server" ></asp:Label></div><div class="status">Brand New Dtr</div></asp:LinkButton>
                    </div>
                    <div class="metro-nav-block nav-block-yellow" style="background-color:#5cb85c;">
                      <asp:LinkButton ID="lnkScrap" runat="server" onclick="TCDetails_Click" > <i class="icon-home"></i><div class="info"><asp:Label ID="lblScrap" runat="server" ></asp:Label></div><div class="status">Scrap Dtr</div></asp:LinkButton>
                    </div>

                     <div class="metro-nav-block nav-light-blue" runat="server" id="Div2" >
                        <asp:LinkButton ID="lnkNotRepairable" runat="server" onclick="TCDetails_Click" > <i class="icon-hospital"></i><div class="info"><asp:Label ID="lblNonRepairable" runat="server" ></asp:Label></div><div class="status">Non Repairable </div></asp:LinkButton>
                    </div>

                    <div class="metro-nav-block nav-light-purple" runat="server" id="Div3" >
                        <asp:LinkButton ID="lnkReleasedGood" runat="server" onclick="TCDetails_Click" > <i class="icon-bitcoin"></i><div class="info"><asp:Label ID="lblReleasedGood" runat="server" ></asp:Label></div><div class="status">Released Good</div></asp:LinkButton>
                    </div>
                                  ...
                                  <Columns>
                                    <asp:TemplateField AccessibleHeaderText="OFF_CODE" HeaderText="Office Code" >                                  
                                        <ItemTemplate>
                                         ...
                                         <FooterTemplate>
                                            <asp:TextBox ID="txtOffCode" runat="server" onpaste="return false" placeholder="Enter Office Code" Width="100px" MaxLength="4" onkeypress="return onlyNumbers(event)"  onchange = "cleanCharAndSpecial(this)"></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="OFF_NAME" HeaderText="Office Name" >                                  
                                        ...
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtOffName" runat="server" onpaste="return false" placeholder="Enter Office Name" Width="200px" onkeypress="return characterAndspecialOff(event)"  onchange = "cleanSpecialAndNumOff(this)" ></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>
