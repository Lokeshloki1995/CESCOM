...
{
    public partial class MisFaultyDTRs : System.Web.UI.Page
    {
        ...
        protected void cmdReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strParam = "id=MisFaultyDtr&Officecode=" + objReport.sOfficeCode;
        ...
        protected void Export_click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                clsException.LogError(ex.StackTrace, ex.Message, strFormName, "Export_click");
            }
        }
