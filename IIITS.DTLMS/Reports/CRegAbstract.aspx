        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span8">
                    ...
                    <h3 class="page-title">Register Abstract Report
                    </h3>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul>
                        <li>This Report Will Display DTC Failure Records</li>
                        <li>It May be CR pending or CR completed, both will display
                        </li>
                    </ul>
                </div>
