<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="MisCommissionPending.aspx.cs" Inherits="IIITS.DTLMS.Reports.MisCommissionPending" %>
                ...
                <div class="span12">
                    ...
                    <div class="widget blue">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i>Pending For Commission</h4> 
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="text-center" align="center">
                                            ...
                                            <asp:Button ID="cmdReport" runat="server" Text="Generate Report" CssClass="btn btn-primary"
                                                ...
                                                <asp:Button ID="Button3" runat="server" Text="Reset" CssClass="btn btn-danger" Visible="false"
                                                     onclick="BtnReset1_Click" /><br />
                                          <br />

                                     
                                        <asp:Button ID="Button2" runat="server" Text="Export Excel"  CssClass="btn btn-info"  Visible="false"
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <ul><li>
                  This Report is used to View the  Count of  DTC that were pending for Invoicing based on One Week  , Fort  Night and Less Than One Month and Greater than One Month   </li>
