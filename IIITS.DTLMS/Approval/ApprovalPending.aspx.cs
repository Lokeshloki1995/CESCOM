    ...
    public partial class ApprovalPending : System.Web.UI.Page
    {
        ...
        public void LoadApprovalPendingDetails()
        {
            try
            {
                ...
                if (sOfficeCode != "")
                {
                    dtLoadDetails = objDashboard.LoadApprovalPendingDetails(sOfficeCode, sBOType);
                }
                else
                {
                    if (cmbDiv.SelectedIndex == 0)
                    ...
                    dtLoadDetails = objDashboard.LoadApprovalPendingDetails(hdfOffCode.Value, sBOType);
                }
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "LoadApprovalPendingDetails");
            }
        }
        ...
        protected void grdApprovePending_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "grdApprovePending_RowCreated");
            }
        }
        ...
        protected void grdApprovePending_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "grdApprovePending_RowCommand");
            }
        }
        ...
        protected void grdApprovePending_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "grdApprovePending_RowDataBound");
            }
        }
        ...
        protected void Export_clickApprovalPending(object sender, EventArgs e)
        {
            ...
            {
                //lblMessage.Text = clsException.ErrorMsg();
                //clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "Export_clickApprovalPending");
            }
