    ...
    public partial class ApprovalPriority : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    AdminAccess();
                    Genaral.Load_Combo("SELECT MO_ID,MO_NAME FROM TBLMODULES ORDER BY MO_ID", "--Select--", cmbModule);
        ...
        public void AddRolesToGrid()
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "AddRolesToGrid");
            }
        }
        ...
        public void LoadRoles(DataTable dt)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "LoadRoles");
            }
        }
        ...
        protected void grdRoles_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdRoles_RowCommand");
            }
        }
        ...
        protected void grdRoles_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdRoles_PageIndexChanging");
            }
        }
        ...
        protected void cmbModule_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "cmbModule_SelectedIndexChanged");
            }
        }
