<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="FeederBifurcation.aspx.cs" Inherits="IIITS.DTLMS.DtcMissMatch.FeederBifurcation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function finalValidateSelectedDTC() {
            ...
            for (i = 1; i < grdOldDTC.rows.length; i++) {
                //grdOldDTC.find('');
                if (grdOldDTC.rows[i].cells[5].getElementsByTagName("INPUT")[0].checked == true) {
                    status = true;
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="span11">
        ...
        <div class="widget blue">
                ...
                <div class="container-fluid">
                    ...
                    <div class="span2">
                        <div class="control-group">
                            ...
                            <asp:DropDownList ID="cmbNewFeeder" runat="server" Style="color: darkblue; font: 100px; border-color: darkblue" OnSelectedIndexChanged="cmbNewFeeder_SelectedIndexChanged" AutoPostBack="true">
                            </asp:DropDownList>
                        </div>
                    </div>
            ...
            <br />
            <div class="span4">
                <asp:Button ID="btnUpdate" Visible="false" Width="250px" runat="server" BackColor="SeaGreen" ForeColor="#ffffff" Style="top: -37px; left: 139px" CssClass="fc-button" Text="Add Selected DTCs to New Feeder" OnClick="btnUpdate_click" OnClientClick="ValidateSelectedDTC();" />
            </div>

            <div class="span1">
                <asp:Button ID="btnReset" Visible="true" Width="100px" runat="server" BackColor="Salmon" ForeColor="#ffffff" Style="top: -37px; left: 1px" CssClass="fc-button" Text="Reset" OnClick="btnReset_click"></asp:Button>
            </div>
            ...
            <div class="span1">
                <asp:Button ID="btnbifurcate" Width="150px" runat="server" BackColor="#ff9933" ForeColor="White" Visible="false" Style="top: -37px;" CssClass="fc-button" Text="Bifurcate DTC's" OnClientClick="finalValidateSelectedDTC();" OnClick="btnbifurcate_click" AUTOPOSTBACK="true" />
            </div>
            <br />
            <br />
            <div class="container-fluid">
                <div class="col-md-4">
                    <asp:GridView ID="grdOldDTC" DataKeyNames="DT_ID" runat="server" AutoGenerateColumns="false">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField AccessibleHeaderText="DT_CODE" HeaderText="DTC Code" Visible="true" ItemStyle-Width="70px">
                ...
                <div class="col-md-6">
                    <asp:GridView ID="gridview2" runat="server" AutoGenerateColumns="false" OnRowCommand="grdDtc_RowCommand">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField AccessibleHeaderText="DT_CODE" HeaderText="Old DTC Code" Visible="true" ItemStyle-Width="70px">
                            ...
                            <asp:TemplateField AccessibleHeaderText="Serial Number" HeaderText="Serial Number" Visible="true" ItemStyle-Width="70px">
                                ...
                                <ItemTemplate>
                                    <asp:TextBox ID="lblDTCseraial" runat="server" Text='<%# Bind("DT_SERIAL_NUMBER") %>' ToolTip="Please Enter the Last Two Digit" CssClass="ChkBoxClass"
                                        Width="20px" MaxLength="2" onblur="getValue(this)" OnKeyPress="javascript: return OnlyAlphabetNumbers(event);"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
