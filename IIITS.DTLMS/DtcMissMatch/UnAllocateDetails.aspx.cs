    ...
    public partial class UnAllocateDetails3 : System.Web.UI.Page
    {
        ...
        public void LoadUnAllocateDetails()
        {
            ...
            catch (Exception ex)
            {
                ...
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "LoadUnAllocateDetailsDetails");
            }
        }
        ...
        protected void grdUnAllocateDetails_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "grdUnAllocateDetails_PageIndexChanging");
            }
        }
        ...
        protected void grdUnAllocateDetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "grdUnAllocateDetails_RowCommand");
            }
        }
