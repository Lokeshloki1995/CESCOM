    ...
    public partial class FieldEnumeration : System.Web.UI.Page
    {
        ...
        public void Reset()
        {
            try
            {
                ...
                dvOldDTCCESC.Style.Add("display", "none");
        ...
        public void ShowUploadedImages()
        {
            try
            {
                clsException.SaveFunctionExecLog("ShowUploadedImages --- START");
                ...
                {
                    dvOldDTCCESC.Style.Add("display", "block");
                ...
                if (txtDTCPath.Text != "")
                {
                    ...
                    if (txtDTCPath.Text.Contains(";"))
                    {
                        ...
                        imgDTCPhoto1.ImageUrl = "ftp://" + sFTPUserName + ":" + sFTPPassword + "@" + sFTPLink.Remove(0, 6) + sDTCPhoto2;
                    }
                    imgDTCPhoto.ImageUrl = "ftp://" + sFTPUserName + ":" + sFTPPassword + "@" + sFTPLink.Remove(0, 6) + txtDTCPath.Text;
                }

                clsException.SaveFunctionExecLog("ShowUploadedImages --- END");
