...
namespace IIITS.DTLMS.Transaction
{
    public partial class DTrAllocation : System.Web.UI.Page
    {
        ...
        public void DTRStoreAllocation()
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "DTRStoreAllocation");
            }
        }
        ...
        protected void btnSearchId_Click(object sender, EventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "btnSearchId_Click");
            }
        }
        ...
        public void VisibleComboType()
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "VisibleComboType");
            }
        }
        ...
        protected void cmbReset_Click(object sender, EventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "cmbReset_Click");
            }
        }
    }
}
