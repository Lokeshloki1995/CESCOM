    ...
    public partial class Division : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["DivId"] != null && Request.QueryString["DivId"].ToString() != "")
                {
                    CheckAccessRights("4");
        ...
        protected void cmdSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ValidateForm() == true)
                {
                    ...
                    if (objSession != null)
                    {
                        objDivision.sUserId = objSession.UserId;
                    }
        ...
        bool ValidateForm()
        {
            ...
            if (txtDivisionCode.Text == "" || txtDivisionCode.Text.Length < 2)
            {
                txtDivisionCode.Focus();
                ShowMsgBox("Please Enter the Division Code");
                return bValidate;
            }
            if(cmbCircle.SelectedValue != txtDivisionCode.Text.Substring(0,1))
            {
                txtDivisionCode.Focus();
        ...
        public void GetDivDetails(string strCircleId)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "GetDivDetails");
            }
