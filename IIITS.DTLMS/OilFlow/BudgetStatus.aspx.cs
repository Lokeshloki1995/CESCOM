...
namespace IIITS.DTLMS.OilFlow
{
    public partial class BudgetStatus : System.Web.UI.Page
    {
        ...
        clsOilTest objbudgetmast = new clsOilTest();
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (objSession.OfficeCode.Length > 1)
                    {
                        ...
                        Genaral.Load_Combo("SELECT DIV_CODE,DIV_NAME FROM TBLDIVISION WHERE DIV_CODE = '" + Officecode + "' ORDER BY DIV_CODE", "--Select--", cmbDivision);
                    ...
                    Genaral.Load_Combo("SELECT  MD_NAME,MD_NAME from TBLMASTERDATA where MD_TYPE = 'FMSACHEAD'  ORDER BY MD_ID", "--Select--", cmbAccCode);
        ...
        protected void cmdLoad_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //GRID VIEW
                //availablebudget = objbudgetmast.getAvailableBudget(objbudgetmast);
