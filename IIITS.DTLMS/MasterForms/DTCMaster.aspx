        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span8">
                    ...
                    <h3 class="page-title">Commisioning of DTC
                    </h3>
                ...
                <div style="float: right; margin-top: 20px; margin-right: 12px">
                    <asp:Button ID="cmdClose" runat="server" Text="DTC View"
                        CssClass="btn btn-primary" OnClientClick="javascript:window.location.href='DTCView.aspx'; return false;" />
                </div>
                                ...
                                <div class="form-horizontal">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span5">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">TC SlNo<span class="Mandotary"> *</span></label>
                                                <div class="controls">
                                                    <div class="input-append">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">TC Make<span class="Mandotary"> </span></label>
                                                <div class="controls">
                                                    <div class="input-append">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">TC Capacity<span class="Mandotary"> </span></label>
                                                <div class="controls">
                                                    <div class="input-append">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        ...
                                                        <asp:CalendarExtender ID="txtConnectionDate_CalendarExtender1" runat="server" CssClass="cal_Theme1"
                                                            TargetControlID="txtConnectionDate" Format="dd/MM/yyyy">
