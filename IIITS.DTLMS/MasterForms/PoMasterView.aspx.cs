...
namespace IIITS.DTLMS.MasterForms
{
    public partial class PoMasterView : System.Web.UI.Page
    {
        ...
        public void LoadPoMasterDetails(string sPoNumber = "")
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "LoadPoMasterDetails");
            }
        }
        ...
        protected void grdPoMasterView_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "grdPoMasterView_PageIndexChanging");
            }
        }
        ...
        protected void grdPoMasterView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Submit")
                {
                    ...
                    Response.Redirect("PoMaster.aspx?QryPoId=" + strPoId, false);
                }
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "grdPoMasterView_RowCommand");
            }
        }
        ...
        protected void cmdNew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ShowMsgBox("This Functionality had moved to MMS .. Please Login to MMS to create Purchase Order");
            }
            catch (Exception ex)
            {
                lblMessage.Text = clsException.ErrorMsg();
