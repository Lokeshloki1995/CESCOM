...
<script type="text/javascript">
    ...
    //Charactes and space to search Store Name
    ...
    //Remove Numbers, Special characters except space to search Store Name
    function cleanSpecialAndNumStore(t) {
                            ...
                            <asp:GridView ID="grdStore" 
                                ...
                                <Columns>
                                  ...
                                  <asp:TemplateField AccessibleHeaderText="SM_NAME" HeaderText="Store Name" SortExpression="SM_NAME">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblName" runat="server" Text='<%# Bind("SM_NAME") %>' style="word-break: break-all;" width="150px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                        <asp:Panel ID="panel1" runat="server" DefaultButton="imgBtnSearch" >
                                          <asp:TextBox ID="txtStoreName" runat="server" placeholder="Enter Store Name" onkeypress="return characterAndspecialStore(event)"  
                                        onchange ="return cleanSpecialAndNumStore(this)" ></asp:TextBox>
                                        </asp:Panel>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="SM_Location" HeaderText="Location" SortExpression="SM_OFF_CODE">                           
                                        <ItemTemplate>
                                            <asp:Label ID="lblLocation" runat="server" Text='<%# Bind("SM_OFF_CODE") %>' style="word-break: break-all;" width="150px"></asp:Label>
                                        </ItemTemplate>
                                         <FooterTemplate>
                                         <asp:Panel ID="panel2" runat="server" DefaultButton="imgBtnSearch" >
                                          <asp:TextBox ID="txtLocation" runat="server" placeholder="Enter Location" onkeypress="return characterAndspecialStore(event)"  
                                        onchange ="return cleanSpecialAndNumStore(this)" ></asp:TextBox>
                                        </asp:Panel>
                                        </FooterTemplate>
                                    </asp:TemplateField>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <ul><li> This Web Page Can Be Used To View All Existing
                        Store and New Store Can Be Added</li>
                <li> Existing Store Details Can Be Edited By Clicking
                        Edit Button</li>
                <li>  New Store Can Be Added By Clicking New Store
                        Button
                   </li></ul>
                </div>
