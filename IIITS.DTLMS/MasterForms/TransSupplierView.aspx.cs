...
namespace IIITS.DTLMS.MasterForms
{
    ...
    {     
        ...
        protected void grdSupplierDetails_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdSupplierDetails_PageIndexChanging");
            }
        }
        ...
        protected void grdSupplierDetails_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace,ex.Message, strFormCode, "grdSupplierDetails_RowDataBound");
        ...
        protected void Export_clickSupplier(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                dt.Columns["TS_BLACK_LISTED"].ColumnName = "BLACK LISTED  ";
                dt.Columns["TS_BLACKED_UPTO"].ColumnName = "BLACK LISTED UPTO  ";
