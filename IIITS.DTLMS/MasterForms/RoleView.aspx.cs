...
namespace IIITS.DTLMS.MasterForms
{
    ...
    public partial class RoleView : System.Web.UI.Page
    {
        ...
        public void LoadRoleGrid()
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "LoadRoleGrid");
            }
        }
        ...
        protected void grdRoleDetails_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                lblMessage.Text = clsException.ErrorMsg();
                clsException.LogError(ex.StackTrace, ex.Message, strFormCode, "grdRoleDetails_PageIndexChanging");
            }
        }
